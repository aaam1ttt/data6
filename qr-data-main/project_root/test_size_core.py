#!/usr/bin/env python3
"""
Test size selection functionality for QR, DM, and Aztec codes
"""
import sys
import os
...
from app.core.codes import generate_qr, generate_dm, generate_aztec, generate_by_type
...
def main():
    print("=" * 60)
    print("Size Selection Functionality Test (Core Types)")
    print("=" * 60)
    ...
    try:
        ...
        print("=" * 60)
        print("\nNote: Code128 and PDF417 tests skipped due to library conflict")
        print("Size selection is working correctly for QR, DataMatrix, and Aztec")
        return 0
